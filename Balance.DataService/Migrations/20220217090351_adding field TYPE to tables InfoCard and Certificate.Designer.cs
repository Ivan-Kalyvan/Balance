...
namespace Balance.DataService.Migrations
{
    ...
    [Migration("20220217090351_adding field TYPE to tables InfoCard and Certificate")]
    partial class addingfieldTYPEtotablesInfoCardandCertificate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Balance.Entities.DbSet.Certificate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Balance.Entities.DbSet.Fact", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Balance.Entities.DbSet.PhotoURL", b =>
                {
                    b.HasOne("Balance.Entities.DbSet.Certificate", "Certificate")
                        .WithOne("PhotoURL")
                        .HasForeignKey("Balance.Entities.DbSet.PhotoURL", "CertificateId");
